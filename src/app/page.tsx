...
import SoundWaveMesh from "@/components/SoundWaveMesh";
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen text-slate-100 flex flex-col font-sans select-none overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 w-full px-6 py-4">
        <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3 rounded-full glass-panel">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-300">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-slate-100 transition-colors">Docs</a>
          </div>
          ...
          <ParallaxContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FloatingCard glowColor="cyan" floatDelay={0} className="flex flex-col gap-4 h-[280px] justify-between">
              <div className="flex flex-col gap-3">
                <div className="w-10 h-10 rounded-xl bg-cyan-950/40 border border-cyan-500/25 flex items-center justify-center text-cyan-400 font-bold text-lg" style={{ transform: "translateZ(30px)" }}>
                  01
                </div>
                <h3 className="text-xl font-bold text-slate-100" style={{ transform: "translateZ(25px)" }}>
                  Neural Mapping
                </h3>
                <p className="text-slate-400 text-sm leading-relaxed" style={{ transform: "translateZ(15px)" }}>
                  Deep neural networks extract acoustic properties to graph vocal tone fluctuations and sub-sensory shifts.
                </p>
              </div>
              <span className="text-xs text-cyan-400 font-semibold uppercase tracking-wider" style={{ transform: "translateZ(10px)" }}>
            ...
            <FloatingCard glowColor="purple" floatDelay={1.5} className="flex flex-col gap-4 h-[280px] justify-between">
              <div className="flex flex-col gap-3">
                <div className="w-10 h-10 rounded-xl bg-purple-950/40 border border-purple-500/25 flex items-center justify-center text-purple-400 font-bold text-lg" style={{ transform: "translateZ(30px)" }}>
                  02
                </div>
                <h3 className="text-xl font-bold text-slate-100" style={{ transform: "translateZ(25px)" }}>
                  Dynamic Waveforms
              ...
              <span className="text-xs text-purple-400 font-semibold uppercase tracking-wider" style={{ transform: "translateZ(10px)" }}>
            ...
            <FloatingCard glowColor="pink" floatDelay={3.0} className="flex flex-col gap-4 h-[280px] justify-between">
              <div className="flex flex-col gap-3">
                <div className="w-10 h-10 rounded-xl bg-pink-950/40 border border-pink-500/25 flex items-center justify-center text-pink-400 font-bold text-lg" style={{ transform: "translateZ(30px)" }}>
                  03
                </div>
                <h3 className="text-xl font-bold text-slate-100" style={{ transform: "translateZ(25px)" }}>
                  Emotional Spectrum
              ...
              <span className="text-xs text-pink-400 font-semibold uppercase tracking-wider" style={{ transform: "translateZ(10px)" }}>
      ...
      {/* FOOTER */}
      <footer className="w-full border-t border-slate-900 py-10 px-6 mt-16 bg-[#050510]">
