...
const colorMap: Record<EmotionType, string> = {
  calm: "#00f0ff",      // Neon Cyan
  energetic: "#ff007a", // Neon Pink
  anxious: "#7000ff",   // Neon Purple
  joyful: "#ffd700",    // Neon Gold/Yellow
};
...
export default function EmotionalOrb({ emotion = "calm", interactive = false }: EmotionalOrbProps) {
  ...
  if (!mounted) {
    const stylesMap2D: Record<EmotionType, string> = {
      calm: "from-cyan-400 to-blue-500 shadow-[0_0_50px_rgba(6,182,212,0.4)] animate-[pulse_3s_infinite]",
      energetic: "from-pink-500 to-rose-600 shadow-[0_0_50px_rgba(244,63,94,0.5)] animate-[bounce_2s_infinite]",
      anxious: "from-purple-500 to-indigo-600 shadow-[0_0_50px_rgba(168,85,247,0.4)] animate-[pulse_1.5s_infinite]",
      joyful: "from-yellow-400 to-amber-500 shadow-[0_0_50px_rgba(234,179,8,0.4)] animate-[pulse_2.5s_infinite]",
    };

    return (
      <div className="w-full h-full flex items-center justify-center">
        <div className={`w-40 h-40 rounded-full bg-gradient-to-tr ${stylesMap2D[emotion]} blur-[2px]`} />
      </div>
    );
  }
