...
export default function ParticleBackground() {
  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      constructor() {
        ...
        // Curated neon colors (cyan, purple, pink, white)
    ...
    const animate = () => {
      ...
      // Draw dynamic radial background glow centered around the mouse
      ...
      // Drift is in the opposite direction of mouse movement to create parallax depth
      ...
      // Draw subtle connecting web lines for particles close to each other
  ...
  return (
    <canvas
      ref={canvasRef}
      className="fixed inset-0 w-full h-full -z-10 pointer-events-none bg-[#050510]"
    />
  );
}
